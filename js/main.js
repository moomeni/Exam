                ...
                for(var i=0;i<categorylinks.length;i++)categorylinks[i].addEventListener("click",function(e){
                    ...
                    function getMovies(){
                        ...
                        e.open("get",URL),e.send(),e.onreadystatechange=function(){
                            4==e.readyState&&200==e.status?(allMovies=(allMovies=JSON.parse(e.response)).results,
                            displayMovies()):
                            console.log("error")}}
                            ...
                            function getMoviesByWord(e){
                                ...
                                a.open("get",t),a.send(),a.onreadystatechange=function(){
                                    4==a.readyState&&200==a.status?(allMovies=(allMovies=JSON.parse(a.response)).results,displayMovies()):
                                    console.log("error")}}
